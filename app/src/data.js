export const data = [
  {
    ...
    short: `I received a job offer mid-course, and the subjects I learned were current, if not more so, 
  ...
  },
  {
    ...
    status: "Verified Graduate",
    short: `Awesome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and 
